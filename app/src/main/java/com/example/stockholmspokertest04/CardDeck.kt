...
class CardDeck {
    ...
    val listOfCards = mutableListOf<Card>(cardClub2,cardClub3,cardClub4,cardClub5,cardClub6,cardClub7,cardClub8,cardClub9,cardClub10,cardClubJack,cardClubQueen,cardClubKing,cardClubAce,
    ...
    var listOfCardsRandom = listOfCards.toMutableList()
