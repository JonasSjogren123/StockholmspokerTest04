...
class DragShadowBuilderGeneral(view: View, image: Int ) : View.DragShadowBuilder(view) {

    //set shadow to be the actual mask
    private val shadow = ResourcesCompat.getDrawable(view.context.resources, image, view.context.theme)
